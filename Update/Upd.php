        ...
        <div class="php">
            <?php
                ...
                if ($result->num_rows > 0) {
                    echo "<table border='1'>";
                    echo "<tr><th>Case ID</th><th>Case Type</th><th>Case Status</th><th>Criminal name</th><th>Date of crime</th><th>Staff ID</th><th>Actions</th></tr>";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a class='edt' href='../Update/Update.php?id=" . $row["Case_id"] . "'>Edit</a></td>";
                        echo "</tr>";
                    }
